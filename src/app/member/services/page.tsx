...
export default function MemberServicesRedirectPage() {
  ...
  useEffect(() => {
    ...
    const fetchAndRedirect = async () => {
      ...
      if (merchantData && isMounted) {
        ...
        const ubosUrl = `/ubos/${category}/${expectedSlug}/services`;
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="bg-white p-8 rounded-3xl shadow-xl shadow-slate-200/50 flex flex-col items-center max-w-md w-full text-center border border-slate-100">
        ...
        <h1 className="text-2xl font-black text-slate-900 tracking-tight mb-2">Memuat Layanan...</h1>
        <p className="text-slate-500 font-medium mb-8">Menyiapkan halaman ekosistem Logaritma.</p>
