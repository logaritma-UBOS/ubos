...
export default function UBOSDashboard() {
  ...
  return (
    <div className="pb-24 md:pb-10 bg-slate-50 min-h-screen">
      ...
      <div className="text-white p-4 md:p-10 pb-6 md:pb-8 rounded-b-[1.5rem] md:rounded-b-[2rem] shadow-xl relative bg-gradient-to-r from-blue-600 to-emerald-500">
        ...
        <div className="relative z-10 max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 md:gap-6">
          ...
          <button 
            ...
            className="w-full md:w-auto bg-white text-emerald-700 px-5 py-2 md:px-6 md:py-2.5 rounded-2xl md:rounded-xl font-bold transition-all hover:-translate-y-0.5 active:scale-95 flex items-center justify-center gap-2 shadow-lg mt-4 md:mt-0 text-sm md:text-base mb-[-24px] md:mb-0 md:mr-4 relative z-30 hover:bg-slate-50 hover:shadow-xl" 
          >
            <Target size={20} />
            TENTUKAN TARGET
          </button>
