            ...
            <div className="relative z-10 text-center space-y-6">
              ...
              <button 
                onClick={() => {
                  ...
                  router.push(`/ubos/jasa/${params.slug}/inventory?onboarding=true`);
                }}
              ...
              >
                Lanjut: Atur Daftar Layanan <ArrowRight size={20} />
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto p-6 md:px-10 mt-2 md:-mt-2 relative z-20 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-1">Total Pelanggan</p>
            <p className="text-2xl font-black text-slate-900">{aiState.totalTransactions} Orang</p>
          </div>
        </div>
        ...
        <div>
          <h2 className="text-lg font-black text-slate-900 mb-4 flex items-center gap-2">
            <Sparkles className="text-teal-600" size={20} /> Asisten AI Logaritma Jasa & Laundry
          </h2>
          <div className="h-[450px]">
            <Copilot inline={true} apiEndpoint="/api/copilot/analyze" />
          </div>
        </div>
