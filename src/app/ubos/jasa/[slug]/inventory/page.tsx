  ...
  return (
    <>
      <header className="fixed top-0 z-40 h-[80px] bg-primary shadow-md max-w-md md:max-w-none mx-auto md:mx-0 left-0 md:left-64 right-0 px-5 py-4 flex justify-between items-center">
        <div>
          <h1 className="text-xl font-bold text-white tracking-tight drop-shadow-sm">Daftar Layanan & Paket</h1>
          <p className="text-white/80 text-xs mt-0.5">Manajemen Harga & Layanan Jasa</p>
        </div>
      </header>
