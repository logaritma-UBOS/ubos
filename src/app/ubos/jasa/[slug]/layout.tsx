    ...
    const checkAuth = async () => {
      ...
      if (merchantData) {
        ...
        if (diff <= 0) {
          ...
          const billingPath = `/ubos/${params.category === 'undefined' ? encodeURIComponent((merchantData.kategori_usaha || 'jasa').toLowerCase().split(' ')[0]) : params.category}/${params.slug}/billing`;
