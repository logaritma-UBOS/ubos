...
export default function StorefrontPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 font-sans">
      ...
      <footer className="w-full py-8 border-t border-[#1e3f20] bg-[#224825] text-center shrink-0">
        <div className="max-w-7xl mx-auto px-4 flex flex-col items-center justify-center space-y-1">
          <p className="text-xs text-emerald-100 font-medium">
            © {new Date().getFullYear()} {merchant?.nama_usaha || 'Toko Online'}. All rights reserved.
          </p>
          <p className="text-[11px] font-bold text-emerald-200 flex items-center gap-1">
            Powered by <span className="text-white font-black tracking-wider">UBOS by Logaritma</span>
          </p>
        </div>
      </footer>
    </div>
