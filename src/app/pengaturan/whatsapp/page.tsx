...
export const metadata: Metadata = {
  title: "Pengaturan WhatsApp - UBOS",
      ...
      <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-slate-900 tracking-tight">Integrasi WhatsApp</h1>
              <p className="text-xs md:text-sm text-slate-500 mt-1">
                Hubungkan nomor WA Bisnis Anda untuk sistem Blast otomatis.
              </p>
            </div>
          </div>
        </div>
