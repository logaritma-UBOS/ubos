  ...
  const programs = [
    {
      ...
      tools: ['Kalkulator HPP', 'Transaksi Kasir POS', 'Analisa AI Copilot', 'CRM & Pelanggan', 'Laporan Harian & Margin'],
      ...
      featured: true,
      syllabusPhases: [
        'Modul 1: Penginputan Resep HPP Bahan Baku',
        'Modul 2: Transaksi Kasir POS',
    ...
    },
    {
      ...
      tools: ['Kalkulator HPP Cetak', 'Transaksi Kasir POS', 'Stok Kertas & Tinta', 'Analisa AI Copilot', 'CRM & Pelanggan', 'Laporan Harian & Margin'],
      originalPrice: 'Rp 149.000',
      discountPrice: 'Rp 49.000',
      installment: 'Langganan Rp 49rb/bln',
    ...
    },
    {
      ...
      tools: ['Kasir Barcode', 'Peringatan Dead-Stock', 'Analisa AI Copilot', 'CRM & Pelanggan', 'Laporan Harian & Margin'],
      originalPrice: 'Rp 149.000',
      discountPrice: 'Rp 49.000',
      installment: 'Langganan Rp 49rb/bln',
      badge: 'Ritel & Warung',
    ...
    },
    {
      ...
      tools: ['HPP Deterjen/Bahan', 'Transaksi Kasir POS', 'Analisa AI Copilot', 'CRM & Pelanggan', 'Laporan Harian & Margin'],
      originalPrice: 'Rp 149.000',
      discountPrice: 'Rp 49.000',
      installment: 'Langganan Rp 49rb/bln',
      badge: 'Laundry & Jasa',
