  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-mesh-glow">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-6 animate-in slide-in-from-top-10 fade-in duration-700">
          <div className="inline-flex items-center gap-2 px-4 py-2 sm:py-1.5 rounded-2xl sm:rounded-full bg-rose-50 border border-rose-200 shadow-sm text-[10px] sm:text-xs font-semibold text-rose-700 hover:border-rose-300 transition-all cursor-default max-w-[90vw] text-center">
            ...
            <span className="font-extrabold text-rose-800 uppercase tracking-wide leading-snug">
              KHUSUS PEMILIK BISNIS KULINER, RITEL, PERCETAKAN & JASA YANG RELA BANTING TULANG TIAP HARI...
            </span>
          </div>
        </div>
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.25] sm:leading-[1.18] animate-in slide-in-from-bottom-8 fade-in duration-700 delay-150 fill-mode-both">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-slate-600 font-normal leading-relaxed max-w-3xl mx-auto px-2 animate-in slide-in-from-bottom-8 fade-in duration-700 delay-300 fill-mode-both">
