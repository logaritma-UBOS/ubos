...
for (const file of files) {
  ...
  // Replace everything from `return (` to `{/* 2. Top Stats Grid - 4 Metric Cards */}`
  ...
  if (startIndex !== -1 && endIndex !== -1) {
    content = content.substring(0, startIndex) + newDashboardHeader.trim() + content.substring(endIndex + endTarget.length);
