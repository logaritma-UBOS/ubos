...
const oldHandleRegister = `      // Record to Leads Database with new schema fields
...
const newHandleRegister = `      // Cek Keberadaan WA di Supabase
...
if (pageCode.includes(oldHandleRegister)) {
  ...
  console.log("Successfully updated register logic in page.tsx");
} else {
  console.log("Could not find old logic in page.tsx. Format might have changed.");
}
