  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-rose-500/20 text-slate-800">
      ...
      <section className="py-8 sm:py-16 px-4 sm:px-6 max-w-4xl mx-auto text-center">
        ...
        >
          {/* Pre-headline */}
          <div className="inline-flex items-center gap-1.5 bg-rose-100 text-rose-700 px-4 py-1.5 rounded-full text-xs sm:text-sm font-black tracking-widest border border-rose-200 uppercase shadow-sm">
...
console.log("Landing page updated with proportional mobile layout.");
