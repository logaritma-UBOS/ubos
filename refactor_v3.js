...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-rose-500/20 text-slate-800">
      ...
      {/* 2. HERO SECTION */}
      <section className="pt-6 sm:pt-16 pb-12 sm:pb-20 px-4 sm:px-6 max-w-4xl mx-auto text-center">
        <motion.div 
        ...
        >
          {/* Pre-headline */}
          <div className="inline-flex items-center gap-1.5 bg-rose-100 text-rose-700 px-3 py-1 rounded-full text-[10px] sm:text-sm font-black tracking-widest border border-rose-200 uppercase shadow-sm mb-3 sm:mb-6">
            🔴 Peringatan untuk Owner F&B, Ritel, & Percetakan
          </div>
          
          {/* Main Headline */}
          <h1 className="text-[26px] sm:text-4xl md:text-5xl lg:text-[54px] font-black text-slate-900 leading-[1.15] sm:leading-[1.1] tracking-tight mb-3 sm:mb-6">
          ...
          {/* Sub-headline */}
          <p className="text-[13px] sm:text-lg text-slate-600 max-w-3xl mx-auto leading-snug sm:leading-relaxed font-medium mb-5 sm:mb-8">
          ...
          <div className="w-full flex flex-col items-center gap-3 sm:gap-4">
            ...
            {/* Micro-trust */}
            <p className="text-[10px] sm:text-sm font-bold text-slate-500 flex items-center justify-center gap-1.5 leading-tight max-w-[280px] sm:max-w-none text-center">
              <ShieldCheck size={16} className="text-emerald-500 shrink-0" /> Sudah Digunakan Ratusan Pemilik UMKM untuk Mengunci Margin & Mencegah Kasir Tekor.
            </p>
          </div>
        </motion.div>
      </section>
...
console.log("Landing page updated with mobile layout optimizations and scroll animations.");
